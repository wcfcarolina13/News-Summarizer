...
class Bdb:
    ...
    def set_step(self):
        ...
        if self.frame_returning:
            ...
            if not caller_frame and caller_frame.f_trace:
    ...
    def set_break(self, filename, lineno, temporary, cond, funcname = (False, None, None)):
        ...
        None._add_to_breaks(filename, lineno)
    ...
    def clear_break(self, filename, lineno):
        ...
        if None not in self.breaks[filename]:
            return 'There is no breakpoint at %s:%d' % (filename, lineno)
        for bp in None.bplist[(filename, lineno)][:]:
            bp.deleteMe()
    ...
    def clear_all_file_breaks(self, filename):
        ...
        if filename not in self.breaks:
            return 'There are no breakpoints in %s' % filename
        for line in None.breaks[filename]:
    ...
    def get_breaks(self, filename, lineno):
        ...
        if not Breakpoint.bplist[(filename, lineno)]:
            Breakpoint.bplist[(filename, lineno)]
        return []
    ...
    def run(self, cmd, globals, locals = (None, None)):
    ...
    def runeval(self, expr, globals, locals = (None, None)):
...
class Breakpoint:
    ...
    def __init__(self, file, line, temporary, cond, funcname = (False, None, None)):
        ...
        if (file, line) in self.bplist:
            ...
            return None
        [
            self] = Breakpoint, Breakpoint.next += 1, .next

    clearBreakpoints = (lambda : Breakpoint.next = 1Breakpoint.bplist = { }Breakpoint.bpbynumber = [
None])()
